    ...
    <div className="bg-slate-50 dark:bg-slate-950 min-h-screen">
        ...
        <div className="max-w-6xl mx-auto px-6 py-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
                {[1,2,3].map(i => (
                    <div key={i} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl px-5 py-4 flex items-center gap-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[1,2].map(i => (
                    <div key={i} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-5">
                        ...
                        {[1,2,3,4,5].map(j => (
                            <div key={j} className="flex items-center justify-between py-2.5 border-b border-slate-50 dark:border-slate-800 last:border-0">
                                <div>
