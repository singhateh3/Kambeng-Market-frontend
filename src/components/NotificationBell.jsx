...
export const NotificationBell = () => {
    ...
    const handleNotificationClick = async (notification) => {
        ...
        if (notification.link) {
            // Make sure the link has /app prefix
    ...
    const getNotificationColor = (type) => {
        const colors = {
            ...
            new_review: 'bg-purple-50 border-l-4 border-purple-500',
        };
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            >
                ...
                {unreadCount > 0 && (
                    <span className="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full min-w-[20px] min-h-[20px]">
                                ...
                                >
                                    <div className="flex items-start justify-between">
                                        ...
                                        <button
                                            ...
                                            className="text-gray-400 hover:text-red-600 ml-2 flex-shrink-0 transition"
                                        >
