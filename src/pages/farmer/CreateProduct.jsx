        ...
        <div className="bg-slate-50 dark:bg-slate-950 min-h-screen">
            ...
            <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
                <div className="max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
                    <div>
                        <h1 className="text-xl font-extrabold text-slate-900 dark:text-slate-100 tracking-tight">List a product</h1>
                        <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Fill in the details to list your produce</p>
                    </div>
                    <button
                        type="button"
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-6">
                        ...
                        <div className="space-y-4">
                            {/* Name */}
                            <div>
                                <label className={labelClass}>Product name <span className="text-red-500 dark:text-red-400">*</span></label>
                                <input
                            ...
                            {/* Variety */}
                            <div>
                                <label className={labelClass}>Variety <span className="text-slate-400 dark:text-slate-500 normal-case font-normal">(optional)</span></label>
                                <input
                            ...
                            {/* Category */}
                            <div>
                                <label className={labelClass}>Category <span className="text-red-500 dark:text-red-400">*</span></label>
                                <select
                            ...
                            {/* Description */}
                            <div>
                                <label className={labelClass}>Description <span className="text-slate-400 dark:text-slate-500 normal-case font-normal">(optional)</span></label>
                                <textarea
                    ...
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label className={labelClass}>Quantity <span className="text-red-500 dark:text-red-400">*</span></label>
                                    <input
                                ...
                                <div>
                                    <label className={labelClass}>Unit <span className="text-red-500 dark:text-red-400">*</span></label>
                                    <select
                                        name="unit"
                            ...
                            {/* Price */}
                            <div>
                                <label className={labelClass}>Price (GMD) <span className="text-red-500 dark:text-red-400">*</span></label>
                    ...
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label className={labelClass}>Harvest date <span className="text-red-500 dark:text-red-400">*</span></label>
                                <input
                            ...
                            <div>
                                <label className={labelClass}>Expiry date <span className="text-red-500 dark:text-red-400">*</span></label>
                                <input
                    ...
                    {/* Photos */}
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-6">
                        <h2 className="text-sm font-bold text-slate-900 dark:text-slate-100 mb-1">Photos <span className="text-slate-400 dark:text-slate-500 font-normal">(up to 5)</span></h2>
                        ...
                        <label className="flex flex-col items-center justify-center border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-xl py-8 px-4 cursor-pointer hover:border-green-400 dark:hover:border-green-600 hover:bg-green-50 dark:hover:bg-green-900/20 transition group">
                            ...
                            <span className="text-sm font-semibold text-slate-600 dark:text-slate-300 group-hover:text-green-700 dark:group-hover:text-green-400">Click to upload photos</span>
                            ...
                            <div className="mt-4 flex flex-wrap gap-3">
                                {photoPreviews.map((preview, i) => (
                                    <div key={i} className="relative group">
                                        <img src={preview} alt={`Preview ${i + 1}`} className="w-20 h-20 object-cover rounded-xl border border-slate-200 dark:border-slate-700" />
                                        <button
                                            type="button"
                                ...
                                {photoPreviews.length < 5 && (
                                    <label className="w-20 h-20 flex items-center justify-center border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-xl cursor-pointer hover:border-green-400 dark:hover:border-green-600 hover:bg-green-50 dark:hover:bg-green-900/20 transition text-slate-400 dark:text-slate-500 hover:text-green-600 dark:hover:text-green-400">
            ...
            {loading && (
                <div className="fixed inset-0 bg-white/70 dark:bg-slate-950/70 backdrop-blur-sm flex flex-col items-center justify-center z-50">
                    <svg className="w-10 h-10 animate-spin text-green-600 dark:text-green-400 mb-4" fill="none" viewBox="0 0 24 24">
                        <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
                        <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8z" />
                    </svg>
                    <p className="text-sm font-semibold text-slate-700 dark:text-slate-200">Uploading your product...</p>
